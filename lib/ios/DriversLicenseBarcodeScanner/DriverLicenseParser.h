...
#define kCameraGaveDLP @"CameraGaveDLP"
#define kDriverLicenceResultCameraKey @"DriverLicenceResultCameraKey"
 ...
 */
@interface DriverLicense (Camera)
+(id)captureByCamera:(UIView*)camView hideSerialAlert:(BOOL)hideSerialAlert;
@end
